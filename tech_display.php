...
$rs=mysqli_query($con,"select candidate_id,full_name,status,qualification from candidate_info where status='Not Schedule'");
while($array=mysqli_fetch_array($rs))
{
	...
	echo "<td>$array[1]";
	 echo "<td>$array[2]";
	 echo "<td>$array[3]";
	 	echo "<td><a href=viewtech_candidate.php?id=$array[0]>View more</a>";	
}
