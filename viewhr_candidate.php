...
<body>
	<div class="container">
		<h1 style="text-align: center;font-family: Constantia;font-size: 30px;color: red"><b>HR Round Scheduling</b></h1>
		<br>
	<form action="insert_hrschedule.php" method="post">
		<?php
		session_start();
		$x=$_GET['id'];
		$_SESSION['a']=$x;
...
echo "<div class=form-group>
        ...
        echo "<div class=col-lg-4>";
echo "<div class=form-group>
          <label for=fullname style=font-size: 16px>HR Head Name:</label><br>";



$rs1=mysqli_query($con,"select fname,mname,lname from hr_register");
