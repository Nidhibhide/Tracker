...
$rs1=mysqli_query($con,"select date,time,name from hr_schedule where candidate_id=$x");
$array1=mysqli_fetch_array($rs1);
echo "<h1 style=text-align:center;font-family:Constantia ;font-size: 30px;><b><font color=red>HR Round Interview</font></b></h1><br>";
   ...
   <div class=row> 
      ...
      <div class=col-lg-4>
        <div class=form-group>
          ...
          <textarea class=form-control readonly rows=1 cols=1>$array1[2]</textarea>
        </div>
      </div>
      <div class=col-lg-4>
        <div class=form-group>
    ...
    <div class=row> 
      <div class=col-lg-4>
        <div class=form-group>
          ...
          <textarea class=form-control readonly rows=1 cols=1>$array[2]</textarea>        
        </div>
      </div>
      <div class=col-lg-4>
        <div class=form-group>
...
<br>
  <div align=center>
<a href=hr_schedule_display.php class="btn btn-primary">Back</a>
</div>";
