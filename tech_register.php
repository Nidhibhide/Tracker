...
$sql="insert into tech_register(fname,mname,lname,username,password,address,mobile_no,adhaar,email) values($fname,$mname,$lname,$user,$pwd,$add,$mob,$adhaar,$email)";
...
<body>
	 <div class="container">
  <h1 style="text-align: center;font-family:Constantia ;font-size: 30;color: red"><b>Tech Registration</b></h1>
  <form name="f1" onsubmit="return validate()" method="post" action="tech_register.php">
  	<div class="row">
  		<div class="col-lg-12">
  	...
  	<div class="row"> 
  		<div class="col-lg-4">
  			<div class="form-group">
  				...
  				<input type="text" class="form-control"  placeholder="Enter First Name" name="txtfrstname" ><p id="a">
  			</div>
  		</div>
  		<div class="col-lg-4">
  			<div class="form-group">
  				<label for="midname" style="font-size: 20px">Middle Name:<sup><font color=red>*</font></sup></label>
  				<input type="text" class="form-control"  placeholder="Enter Middle Name" name="txtmidname" ><p id="b">
  			</div>
  		</div>
  		<div class="col-lg-4">
  			<div class="form-group">
  				<label for="lstname" style="font-size: 20px">Last Name:<sup><font color=red>*</font></sup></label>
  				<input type="text" class="form-control"  placeholder="Enter Last Name" name="txtlstname" ><p id="c">
  			</div>
  		</div>	
  	</div>
  	<div class="row"> 
  		<div class="col-lg-4">
  			<div class="form-group">
  				...
  				<input type="email" class="form-control"  placeholder="Enter Username" name="txtuser" ><p id="d">
  			</div>
  		</div>
  		<div class="col-lg-4">
  			<div class="form-group">
  ...
  <div class="row"> 
  		...
  		<div class="col-lg-4">
  			<div class="form-group">
  				...
  				<input type="email" class="form-control"  placeholder="Enter Email ID" name="txtemail" ><p id="j">
  			</div>
  		</div>	
  	</div>	
    <br>
