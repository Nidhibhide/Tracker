...
$b=$_REQUEST['txtpwd'];
$flag=0;
$rs=mysqli_query($con,"select username,password from tech_register") or die("couldnt execute query");
...
if($flag==1)
{
  session_start();
  $_SESSION['username']=$a;
header("location:techdashboard.html");
/*echo '<div class="alert alert-danger alert-dismissable">
    <a href="#" class="close" data-dismiss="alert" aria-label="close"><font size=6>×</font></a>
    <strong><font size=4 color=black>Login successful!! Try Again</strong>
  </div>';*/
}
else
{
...
<body>
	<div class="container">
  <h1 style="text-align: center;font-family:Constantia ;font-size: 30;color: red"><b>Tech Login</b></h1>
  <form action="techlogin.php" name="f2"  method="post">
    ...
    <input type="submit" class="btn btn-primary" name="btn">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="tech_forgot_pwd.php" style="font-size: 18px;color: red;font-family: Arial"><b>Forgot Password</b></a>
