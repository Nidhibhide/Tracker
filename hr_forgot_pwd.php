...
$con=mysqli_connect("localhost","root","","website") or die("Coudlnt connect with sql");
$rs=mysqli_query($con,"select mobile_no from hr_register where username=$user") or die("couldnt execute query");
...
if("'".$array[0]."'"==$mobno)
{
	...
	//echo "start";
	$sql="update hr_register set password=$pwd where username=$user";
...
echo '<div class="alert alert-danger alert-dismissable">
    ...
    <strong><font size=4 color=black>Failed Operation!!! </strong>
  </div>';
...
<body>
  <div class="container">
  <h1 style="text-align: center;font-family:Constantia ;font-size: 30;color: red"><b>HR Forgot Password</b></h1>
  <form  name="f2"  method="post" onsubmit="return validate()" action="#">
